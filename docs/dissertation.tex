...
\lstdefinelanguage{unison}{
  ...
  %keyword4
  morekeywords = [3]{Status, BasicIO, User, Environment, Session, PState, Done, Paused, Interrupt, TimeSharing, Alice, Bob, Root, State, FileSystem, FileSystemT, FileRW, FileCO, FileLU, INode, INodeT, IList, IListT, DataRegion, DataRegionT, Directory, DirectoryT},
  %keyword5
